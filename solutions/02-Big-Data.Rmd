...
Use a four step workflow to manipulate data stored in a database with dplyr:
...
**Exercise 1**: *In the code chunk below, use a dplyr driver function to open a connection to the Airlines database. Note this chunk will not run until you remove the chunk option `eval = FALSE`*.
