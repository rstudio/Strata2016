...
babynames_tbl <- spark_read_parquet(sc, name = "babynames", path = "data/babynames-parquet/babynames")
applicants_tbl <- spark_read_parquet(sc, name = "applicants", path = "data/babynames-parquet/applicants")
